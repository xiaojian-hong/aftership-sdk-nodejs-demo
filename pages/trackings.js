...
const Trackings = () => {
	...
	const handleGetSingleTracking = (e) => {
		if (!apiKey) {
			alert('Please enter your API key first');
			return;
		}
	...
	const handleRetrack = () => {
		...
		aftership.tracking
			...
			.then((result) => {
				setPostTrackingBySlugAndNumberData(result.tracking);
			})
			.catch((e) => alert(e.message));
	};

	const handleAddTrackingNumber = (e) => {
	...
	return (
		<div className='container'>
			...
			<main>
				<h1 className='title'>Trackings endpoint</h1>
				...
				<div className='resource'>
					<div className='card'>
						<a onClick={handleCreateTracking}>
						...
						<div className='fields'>
							<input
								...
								onChange={handleAddTrackingNumber}
							/>
						</div>
						<div>
					...
					<div className='card'>
						<a onClick={handleDeleteTracking}>
					...
					<div className='card'>
						<a onClick={handleGetSingleTracking}>
					...
					<div className='card'>
						<a onClick={handleUpdateTracking}>
